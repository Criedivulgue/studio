  ...
  return (
    <div className="flex-1 space-y-4 p-4 md:p-8 pt-6">
      <Heading 
        ...
        description="Visualização de todos os grupos da plataforma."
      />
      <Separator />
      ...
      <div className="flex flex-col items-center justify-center h-64 bg-secondary/50 border border-dashed rounded-lg text-center p-8">
        ...
        <p className="text-muted-foreground mt-2 max-w-md">
          Como Super Administrador, sua capacidade de visualizar os grupos de outros administradores foi intencionalmente desativada para garantir a privacidade e o isolamento dos dados de cada usuário.
        </p>
